...
class Paths:
    def __init__(
        ...
        self.train = self.root / "validation" / "filtered" / "split" / env / "train_test" / "train"
        self.test = self.root / "validation" / "filtered" / "split" / env / "train_test" / "test"
        self.full = self.root / "validation" / "filtered" / "full"
        ...
        if model_type in ["benchmark", "ensemble"]:
            ...
            self.logs = self.root / "validation" / "logs" / env / model_type / annot_family / log_run_dir
            self.plots = self.logs / "validation" / "plots"
        ...
        self.config_in = self.root / "validation" / "models" / model_dir
